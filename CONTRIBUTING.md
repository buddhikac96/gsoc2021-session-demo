...
This guide will help to contribute any open source project.
...
6.  Commit your changes using a descriptive commit message.
    ...
    ```
    There are some naming conventions when adding the message. [This article will helpful to you](https://chris.beams.io/posts/git-commit/).
